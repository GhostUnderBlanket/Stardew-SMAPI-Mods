...
namespace FishingAssistant2.Framework.Components
{
    ...
    internal class SliderOptionsElement : BaseOptionsElement
    {
        ...
        *********/
        ...
        public SliderOptionsElement(string label, int value, int maxValue, Action<int> setValue, int minValue = 0, Func<bool>? disabled = null, Func<int, string>? format = null, int width = 48)
