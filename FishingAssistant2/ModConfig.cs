...
namespace ChibiKyu.StardewMods.FishingAssistant2
{
    internal class ModConfig
    {
        ...
        /// AUTOMATION ///
        /// <summary>Toggle for auto cast fishing rod.</summary>
        public bool AutoCastFishingRod { get; set; } = true;

        /// <summary>Toggle for auto hook fish.</summary>
        ...
        /// <summary>Preference for cast power.</summary>
        ...
        /// <summary>Show a preview for all fish species, even ones you have never caught.</summary>
